  ...
  <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
      <div class="widget-content widget-content-area br-8">
        <table id="individual-col-search" class="table dt-table-hover">
              ...
              <tbody>
                @foreach ($lawyer_court as $key => $lawyer_courtlist)
                <tr>
                    <td></td>
                    <td>{{ $key + 1 }}</td>
                  <td>{{ $lawyer_courtlist->name }}</td>
                  <td>{{ $lawyer_courtlist->email }}</td>
                  <td>{{ $lawyer_courtlist->location }}</td>
                  <td>{{ $lawyer_courtlist->court_category_id }}</td>
                  <td>{{ $lawyer_courtlist->country_id }}</td>
                  <td>{{ $lawyer_courtlist->state_id }}</td>
                  <td>{{ $lawyer_courtlist->city_id }}</td>
                  <td>{{ $lawyer_courtlist->room_number }}</td>
                  <td>{{ $lawyer_courtlist->description }}</td>
                              ...
                              <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-xxl-0">
                                  <div class="widget-content widget-content-area blog-create-section">
                                      <form id="add_form" class="form-horizontal needs-validation"
                                          action="{{ route('lawyer-court.store') }}" method="POST"
                                          novalidate>
                                          @csrf
