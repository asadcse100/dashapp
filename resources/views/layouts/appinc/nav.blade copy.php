        ...
        <li class="service-drpdown">
            ...
            <div class="my-drpdown-menu">
                ...
                <div class="my-drpdown-item">
                    <a class="my-drpdown-item-a" href="{{ route('filter_category', $service->id) }}">{{ $service->name }}</a>
                    <ul class="sub-menu px-0 py-3">
                        ...
                        @foreach($filtereds as $key => $filtered)
                            <li class="sub-menu-li"><a class="sub-menu-a" href="{{ Route('filter_category_with_service', [$service->id, $filtered->id]) }}">{{ $filtered->title }}</a></li>
                        @endforeach
                        @endif
                    </ul>
                </div>
