        ...
        <table id="individual-col-search" class="table dt-table-hover">
            ...
            <tbody>
                @foreach ($freelancers as $key => $freelancer)
                    <tr>
                        <td>{{ $key + 1 + ($freelancers->currentPage() - 1) * $freelancers->perPage() }}
                        </td>
                        ...
                        @php
                            $verification = \App\Models\Verification::where('user_id', $freelancer->user_id)
                                ->where('role_id', '2')
                                ->first();
                        @endphp
                        <td>
                        ...
                        <td class="text-right">
                            @if ($freelancer->user != null)
                                <a href="{{ route('freelancer_info_show', $freelancer->user->user_name) }}"
                            ...
                            @if ($freelancer->user->banned)
                                <a href="javascript:void(0)"
                                    data-href="{{ route('user.ban', $freelancer->user->id) }}"
