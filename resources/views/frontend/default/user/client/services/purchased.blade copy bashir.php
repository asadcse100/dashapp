                            ...
                            <table class="table aiz-table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a target="_blank"
                                                href="{{ route('freelancer.details', $purchasedService->freelancer->user_name) }}">{{ $purchasedService->freelancer->name }}</a>
                                        </td>
                                        ...
                                        <td>
                                            @if ($purchasedService->cancel_status == 0 &&
                                            $purchasedService->cancel_requested == 0)
