                                        ...
                                        <div class="d-flex">
                                            <a href="" target="_blank" class="avatar flex-shrink-0 mr-4">
                                                @if ($bid_user->freelancer->photo != null)
                                                    <img
                                                        src="{{ asset('profile/photos/' . $bid_user->freelancer->photo) }}">
                                                @else
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <div class="d-flex text-secondary fs-12 mb-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        @if ($bid_user->freelancer->address != null &&
                                                            $bid_user->freelancer->address->city != null &&
                                                            $bid_user->freelancer->address->country != null)
                                                            <span>{{ $bid_user->freelancer->address->city->name }},
                                                                {{ $bid_user->freelancer->address->country->name }}</span>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
