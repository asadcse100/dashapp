                            ...
                            @if ($bookmarked_freelancer->freelancer != null)
                                <div class="col-lg-4 col-md-6">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <a href="{{ route('freelancer.details', $bookmarked_freelancer->freelancer->user_name) }}"
                                                class="text-inherit">
                                                <div class="px-4 text-center mb-3">
                                                    <span class="avatar avatar-md mb-3">
                                                        @if ($bookmarked_freelancer->freelancer->photo != null)
                                                            <img
                                                                src="{{ asset('profile/photos/' . $bookmarked_freelancer->freelancer->photo) }}">
                                                        @else
                                                            <img
                                                    ...
                                                    <div class="text-secondary fs-10 mb-1">
                                                        ...
                                                        <span>
                                                            ({{ getNumberOfReview($bookmarked_freelancer->freelancer->id) }}
                                                            {{ translate('Reviews') }})
                                                        </span>
                                                    </div>
                                                    <h4 class="h5 mb-2 fw-600">
                                                        {{ $bookmarked_freelancer->freelancer->name }}</h4>
                                            ...
                                            <div class="mb-4">
                                                <div class="media mb-3">
                                                    ...
                                                    <div class="media-body pt-2">
                                                        @if ($bookmarked_freelancer->freelancer != null &&
                                                            $bookmarked_freelancer->freelancer->address != null &&
                                                            $bookmarked_freelancer->freelancer->address->city != null &&
                                                            $bookmarked_freelancer->freelancer->address->country != null)
                                                            <span
                                                                class="d-block font-weight-medium">{{ $bookmarked_freelancer->freelancer->address->city->name }},
                                                                {{ $bookmarked_freelancer->freelancer->address->country->name }}</span>
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="media mb-3">
                                                    ...
                                                    <div class="media-body pt-2">
                                                        <span
                                                            class="d-block font-weight-medium">{{ count(getCompletedProjectsByFreelancer($bookmarked_freelancer->freelancer_user_id)->get()) }}
                                                ...
                                                <div class="media">
                                                    ...
                                                    <div class="media-body pt-2">
                                                        <span
                                                            class="d-block font-weight-medium">{{ single_price(\App\Models\MilestonePayment::where('freelancer_user_id', $bookmarked_freelancer->freelancer_user_id)->where('paid_status', 1)->sum('freelancer_profit')) }}
                                                            total earnings</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="flex-shrink-0 d-flex justify-content-between align-items-center">
                                                <div class="text-right">
                                                    <h4 class="mb-0">
                                                        {{ single_price($bookmarked_freelancer->freelancer->profile->hourly_rate) }}
                                                    </h4>
