                                                    ...
                                                    <div id="autosaving" class="row layout-spacing">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div>
                                                                ...
                                                                <textarea id="about_service" name="about_service"
                                                                    rows="40"
                                                                    cols="50"> {!! $service->about_service !!} </textarea>
                                                    ...
                                                    <div class="col-sm-6 mb-4">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <select class="form-select aiz-selectpicker"
                                                                ...
                                                                @foreach (\App\Models\ProductCategory::where('status',
                                                                1)->get() as $category)
                                                                <option value="{{ $category->id }}"
                                                                    {{ $category->name }} @if($category->id ==
                                                                    $service->product_category_id) selected @endif>
                                                                    {{ $category->name }}
                                                                </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="account-content">
                                                                    ...
                                                                    <ul class="nav nav-tabs" id="animateLine"
                                                                        ...
                                                                        <li class="nav-item">
                                                                            <a class="nav-link @if($loop->iteration == 1) active @endif"
                                                                                id="{{ $service_package->service_type }}-tab"
                                                                                data-bs-toggle="tab"
                                                                                href="#{{ $service_package->service_type }}"
                                                                                role="tab"
                                                        ...
                                                        <div class="tab-content" id="animateLineContent-4">
                                                            ...
                                                            <div class="tab-pane fade show @if($loop->iteration == 1) active @endif"
                                                                id="{{ $service_package->service_type }}"
                                                                role="tabpanel"
                                                                ...
                                                                <div class="row">
                                                                    <div
                                                                        ...
                                                                        <div class="info">
                                                                            <h6>{{ $service_package->service_type }}
                                                                                Packages</h6>
                                                                            <div class="row ">
                                                                                <div class="col-lg-11 mx-auto">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div id="autosaving"
                                                                                            ...
                                                                                            <div class="col-lg-12">
                                                                                                ...
                                                                                                <div>
                                                                                                    ...
                                                                                                    @if($service_package->service_type
                                                                                                    == 'basic')
                                                                                                    <textarea
                                                                                                        id="basic_included_description"
                                                                                                        name="basic_included_description"
                                                                                                        rows="40"
                                                                                                        cols="50"> {!! $service_package->feature_description !!} </textarea>
                                                                                                    @elseif($service_package->service_type
                                                                                                    == 'standard')
                                                                                                    <textarea
                                                                                                        id="standard_included_description"
                                                                                                    ...
                                                                                                    == 'premium')
                                                                                                    <textarea
                                                                                                        id="premium_included_description"
