                            ...
                            <div class="row">
                                <div class="col-xl-8 offset-xl-2 text-center">
                                    <h1 class="h5 mt-3 mt-lg-0 mb-5 fw-400">{{ translate('Total') }} <span
                                        ...
                                        {{ translate('freelancers found for') }}
                                                            ...
                                                            <a href="{{ route('freelancer.details', $freelancer->user->user_name) }}"
                                                                ...
                                                                <span class="avatar flex-shrink-0 mr-4">
                                                                    ...
                                                                    @if ($freelancer->user->photo != null)
                                                                        {{-- <img src="{{ asset('profile/photos/' . $freelancer->user->photo) }}"
                                                                ...
                                                                <div class="container flex-grow-1">
                                                                    <h5 class="fw-600 mb-1">{{ $freelancer->user->name }}
                                                                    </h5>
                                                                    @if ($freelancer->specialistAt != null)
                                                                        <p class="opacity-50">
                                                                            {{ $freelancer->specialistAt->name }}
                                                                        </p>
                                                                    @endif

                                                                    <div class="text-muted lh-1-8">
                                                                        <p class="text-truncate-3">{{ $freelancer->bio }}
                                                                        </p>
                                                                    </div>
                                                                    ...
                                                                    <div class="d-flex text-secondary fs-12 mb-3">
                                                                        ...
                                                                        @if ($freelancer->user->address->city_id != null && $freelancer->user->address->country_id != null)
                                                                            <div>
                                                                                ...
                                                                                <span>{{ $freelancer->user->address->city->name }},
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="text-right">
                                                                        <h4 class="mb-0">
                                                                            {{ single_price($freelancer->hourly_rate) }}
                                                                        </h4>
