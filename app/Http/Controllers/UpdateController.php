...
class UpdateController extends Controller
{
    ...
    public function step1() {
        if(SystemConfiguration::where('type', 'current_version')->first() != null && SystemConfiguration::where('type', 'current_version')->first()->value == '1.5'){
            $sql_path = base_path('sqlupdates/v16.sql');
            DB::unprepared(file_get_contents($sql_path));
        }
        elseif(SystemConfiguration::where('type', 'current_version')->first() != null && SystemConfiguration::where('type', 'current_version')->first()->value == '1.4'){
