...
class DataController extends Controller
{
    ...
    public function getSubCategoryData(Request $request){
        ...
        /* dd(DB::getQueryLog(),$Cat_ID, $request->cat_name, $Cat_ID[0]->id); */
        /* $subservice_list = ProductService::where('status',1)->where('category_id',$request->cat_id)->select('id','title')->get(); */
