                ...
                <div class="col-lg-3 col-md-6">
                    <label class="logo" id="logo">
                        <a href="<?php echo e(Route('home')); ?>">
                            <img src="<?php echo e(asset('templete')); ?>/src/assets/img/zerop.png" alt="ZeroPlus" class="zeropimg"
        ...
        <div class="pt-4 pb-1 position-relative">
            <div class="container">
                <p class="text-white text-center text-md-left mt-0">
                    <span class="text-success">ZeroPlus</span> &copy; <?php echo e(date('Y')); ?> All Right Reserved
                </p>
            </div>
        </div>
    </div>
...
<!-- Footer End -->
<?php /**PATH D:\Server\Xampp\htdocs\zeroplus20\resources\views/layouts/appinc/footer.blade.php ENDPATH**/ ?>