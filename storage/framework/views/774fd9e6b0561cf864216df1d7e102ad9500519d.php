    ...
    <div class="layout-px-spacing">
        <div class="middle-content container-xxl p-0">
            <div class="col-md-3   layout-top-spacing">
                <h5 class="mb-md-0 h6"><?php echo e(translate('Cancel Purchased Services')); ?></h5>
            </div>
                        ...
                        <tr>
                            ...
                            <?php if(\App\Addon::where('unique_identifier', 'offline_payment')->first() != null &&
                                ...
                                <th data-breakpoints="" width="15%">
                                    <?php echo e(translate('Approval') . ' ( ' . translate('For Manual Payment') . ' )'); ?></th>
                            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH J:\Server\htdocs\zeroplus20\resources\views/frontend/default/user/client/services/cancelled.blade.php ENDPATH**/ ?>