...
<nav id="navbars">
    ...
    <label class="logo" id="logo">
        <a href="<?php echo e(Route('home')); ?>">
            <img src="<?php echo e(asset('templete')); ?>/src/assets/img/zerop.png" alt="ZeroPlus"
                class="zeropimg" /></a>
    </label>
    <ul id="uldesign">
...
<?php /**PATH D:\Server\Xampp\htdocs\zeroplus20\resources\views/layouts/appinc/nav.blade.php ENDPATH**/ ?>