                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                        <div class="info">
                                            ...
                                            <div class="row">
                                                <form method="POST" action="<?php echo e(route('passupdate')); ?>">
                                                    <?php echo csrf_field(); ?>
                                                    ...
                                                    <div class="text-center">
                                                        <button type="submit"
                                                            class="btn btn-success transition-3d-hover mr-1"><?php echo e(translate('Password Update')); ?></button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                    ...
                                    <div class="section general-info payment-info">
                                        <div class="info">
                                            ...
                                            <div class="text-right">
                                                <button type="submit"
                                                    class="btn btn-primary transition-3d-hover mr-1"><?php echo e(translate('Add')); ?></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                            ...
                                                            <div class="dropdown selectable-dropdown cardName-select">
                                                                <a id="cardBrandDropdown" href="javascript:void(0);"
                                                                    ...
                                                                    aria-haspopup="true" aria-expanded="false"><img
                                                                        src="<?php echo e(asset('templete')); ?>/src/assets/img/card-mastercard.svg"
                                                                ...
                                                                <div class="dropdown-menu"
                                                                    ...
                                                                    <a class="dropdown-item"
                                                                        data-img-value="<?php echo e(asset('templete')); ?>/src/assets/img/card-mastercard.svg"
                                                                        ...
                                                                        Mastercard</a>
                                                                    <a class="dropdown-item"
                                                                        data-img-value="<?php echo e(asset('templete')); ?>/src/assets/img/card-americanexpress.svg"
                                                                        data-value="IDR - Indonesian Rupiah"
                                                                        href="javascript:void(0);"><img
                                                                            src="<?php echo e(asset('templete')); ?>/src/assets/img/card-americanexpress.svg"
                                                                            class="flag-width" alt="flag"> American
                                                                        Express</a>
                                                                    <a class="dropdown-item"
                                                                        data-img-value="<?php echo e(asset('templete')); ?>/src/assets/img/card-visa.svg"
                                                                        data-value="USD - US Dollar"
                                                                        href="javascript:void(0);"><img
                                                                            src="<?php echo e(asset('templete')); ?>/src/assets/img/card-visa.svg"
                                                                            class="flag-width" alt="flag"> Visa</a>
                                                                    <a class="dropdown-item"
                                                                        data-img-value="<?php echo e(asset('templete')); ?>/src/assets/img/card-discover.svg"
                                                                        data-value="INR - Indian Rupee"
                                                                        href="javascript:void(0);"><img
                                                                            src="<?php echo e(asset('templete')); ?>/src/assets/img/card-discover.svg"
                                                                            class="flag-width" alt="flag">
                                                                        Discover</a>
                                                                </div>
                                                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Server\Xampp\htdocs\dashapp\resources\views/frontend/default/user/freelancer/setting/account.blade.php ENDPATH**/ ?>