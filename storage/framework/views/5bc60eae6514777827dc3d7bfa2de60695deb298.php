        ...
        <ul class="list-unstyled menu-categories">
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="service" data-bs-parent="#accordionExample">
                    <li>
                        <a href="<?php echo e(route('service.freelancer_index')); ?>"> All Services </a>
                    </li>
                    <li>
...
<?php /**PATH D:\Server\Xampp\htdocs\zeroplus20\resources\views/layouts/inc/freelancer_sidebar.blade.php ENDPATH**/ ?>