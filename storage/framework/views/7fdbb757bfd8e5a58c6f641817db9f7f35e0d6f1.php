                                    ...
                                    <?php if($freelancer->photo != null): ?>
                                        ...
                                        <?php if(Cache::has('user-is-online-' . $freelancer->id)): ?>
                                            <div class="avatar avatar-xl avatar-indicators avatar-online">
                                                <img src="<?php echo e(asset('profile/photos/' . $freelancer->photo)); ?>"
                                        ...
                                        <div class="card border-dark">
                                            <a href="<?php echo e(route('service.show', $service->slug)); ?>">
                                                <?php if(!empty($service->image)): ?>
                                                    <img src="<?php echo e(asset('storage/uploads/services/' . $service->image)); ?>"
                                                        class="card-img-top" alt="<?php echo e($service->slug); ?>" height="160">
                                                <?php else: ?>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="<?php echo e(route('service.show', $service->slug)); ?>" class="text-dark">
                                                    <p class="card-title">
                                                        <?php echo e(\Illuminate\Support\Str::words($service->title, 7, $end = '...')); ?>
                                            ...
                                            <div class="card-footer justify-content-between">
                                                <span>Starting at
                                                    <?php if(isset($service->service_packages)): ?><?php echo e(single_price($service->service_packages[0]->service_price)); ?><?php endif; ?></span>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="media">
                                                <div class="mr-3">
                                                    <span class="avatar avatar-md m-3">
                                                        ...
                                                        <img src="<?php echo e(asset('profile/photos/' . \App\Models\User::find($review->reviewer_user_id)->photo)); ?>"
                                            ...
                                            <?php if($user_badge->badge != null): ?>
                                                <span class="avatar avatar-square avatar-xxs"
                                                    title="<?php echo e($user_badge->badge->name); ?>"><img
                                                        src="<?php echo e(asset('profile/badge/' . $user_badge->badge->icon)); ?>"></span>
                                            <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                    ...
                    <div class="my-2">
                        ...
                        <?php else: ?>
                            <a class="btn btn-block btn-outline-primary"
                                ...
                                <i class="las la-bookmark"></i>
                                <span><?php echo e(translate('Bookmark Expert')); ?></span>
                            </a>
                        <?php endif; ?>
                    </div>
                </div>
...
<?php echo $__env->make(Auth::guest() ? 'layouts.appindex' : 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Server\Xampp\htdocs\dashapp\resources\views/frontend/default/freelancer-single.blade.php ENDPATH**/ ?>