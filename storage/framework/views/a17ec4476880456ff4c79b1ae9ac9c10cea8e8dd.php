  ...
  <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
      <div class="widget-content widget-content-area br-8">
        <table id="individual-col-search" class="table dt-table-hover">
              ...
              <tbody>
                <?php $__currentLoopData = $lawyer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $lawyerlist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td></td>
                    <td><?php echo e($key + 1); ?></td>
                  <td><?php echo e($lawyerlist->name); ?></td>
                  <td><?php echo e($lawyerlist->email); ?></td>
                  <td><?php echo e($lawyerlist->mobile_no); ?></td>
                  <td><?php echo e($lawyerlist->description); ?></td>
                              ...
                              <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-xxl-0">
                                  <div class="widget-content widget-content-area blog-create-section">
                                      <form id="add_form" class="form-horizontal needs-validation"
                                          action="<?php echo e(route('lawyer.store')); ?>" method="POST"
                                          novalidate>
                                          <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\zeroplus20\resources\views/common/lawyer/lawyer_setup/index.blade.php ENDPATH**/ ?>