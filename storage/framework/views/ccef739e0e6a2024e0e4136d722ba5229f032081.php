                    ...
                    <div class="statbox widget box box-shadow">
                        <div class="widget-content widget-content-area">
                            ...
                            <div class="seperator-header text-center">
                                <h4 class=""><?php echo e(__('My Referral List')); ?></h4>
                            </div>
                            <?php if(sys_settings('referral_show_referred_users', 'no') == 'yes'): ?>
                                <table class="multi-table table dt-table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $refers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $refer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($key + 1); ?></td>
                                                <td><a href="<?php echo e(Route('freelancer.details', $refer->referred->user_name)); ?>"><?php echo e($refer->referred->name); ?></a></td>
                            ...
                            <?php endif; ?>
                            <div class="seperator-header text-center">
                                <h4 class=""><?php echo e(__('My Referral Commissions')); ?></h4>
                            </div>
                            <table class="multi-table table table-striped dt-table-hover table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tranx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($tranx->trans_details); ?></td>
                                            <td><?php echo e(show_date(data_get($tranx, 'created_at'), true)); ?></td>
                                            <td>
                                                <?php if($tranx->status == 2): ?>
                                                    Completed
                                                <?php else: ?>
                                                    Pending
                                                <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Server\Xampp\htdocs\dashapp\resources\views/frontend/referral/index.blade.php ENDPATH**/ ?>