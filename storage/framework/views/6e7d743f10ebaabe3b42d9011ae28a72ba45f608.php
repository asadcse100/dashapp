            ...
            <div class="page-meta">
                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <a href="<?php echo e(route('service.create')); ?>" class="btn btn-light-info mb-2 me-4">Add
                                Service</a>
                        </div>
                    </div>
                </nav>
                                    ...
                                    <div class="card">
                                        <a href="<?php echo e(route('service.show', $service->slug)); ?>">
                                            <?php if(!empty($service->image)): ?>
                                                <img src="<?php echo e(asset('storage/uploads/services/' . $service->image)); ?>"
                                                    class="card-img-top" alt="<?php echo e($service->slug); ?>.">
                                            <?php else: ?>
                                        ...
                                        <div class="media mt-4 mb-0 pt-1 container">
                                            <?php if(!empty(Auth::user()->photo)): ?>
                                                <img src="<?php echo e(asset(Auth::user()->photo)); ?>" class="card-media-image me-3"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Server\Xampp\htdocs\zeroplus20\resources\views/frontend/default/user/freelancer/projects/services/index.blade.php ENDPATH**/ ?>